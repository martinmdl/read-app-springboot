...
class Libro(
    ...
    var paginas: Int, //necesario en: 'TipoLector.kt/LectorFanatico'
    ...
    fun setVentaSemanales(ventasSemanales: Int) {
        this.ventasSemanales = ventasSemanales
    }

    fun setEditarEdiciones(ediciones: Int) {
    ...
    fun setLecturaCompleja(lecturaCompleja: Boolean) {
        this.lecturaCompleja = lecturaCompleja
    }

    fun setEdiciones(ediciones: Int) {
        this.ediciones = ediciones
    }

    fun setVentasSemanales(ventasSemanales: Int) {
        this.ventasSemanales = ventasSemanales
    }
}