...
class UsuarioBuilder {
    ...
    fun recomendacionesPorValorar(recomendacionesPorValorar: MutableSet<Recomendacion>) =
        apply { this.recomendacionesPorValorar = recomendacionesPorValorar }
...
class RecomendacionBuilder {
    ...
    fun librosRecomendados(librosRecomendados: MutableSet<Libro>) =
        apply { this.librosRecomendados = librosRecomendados }
