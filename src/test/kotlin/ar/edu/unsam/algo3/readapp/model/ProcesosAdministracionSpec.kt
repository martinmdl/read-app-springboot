...
import ar.edu.unsam.algo3.model.Encuentro
import ar.edu.unsam.algo3.model.Particular
import ar.edu.unsam.algo3.utils.*
...
class ProcesosAdministracionSpec : DescribeSpec ({
    ...
    //Recomendaciones
    val recomendacion1 = usuario1.crearRecomendacion("Recomendacion 1",libros, "recomiendo", false)
    val recomendacion2 = usuario2.crearRecomendacion( "Recomendacion 2",libros, "no recomiendo", true)
