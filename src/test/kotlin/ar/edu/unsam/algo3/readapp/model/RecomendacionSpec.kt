    ...
    describe("Test de las Recomendaciones") {
        ...
        describe("Test de leer recomendacion") {
            ...
            it("Creador puede leer la recomendacion") {
                ...
                recomendacion1.puedeLeerLaRecomendacion(usuario1) shouldBe true
            }
            it("amigo puede leer la recomendacion") {

                recomendacion3.puedeLeerLaRecomendacion(usuario1) shouldBe true
            }
            it("usuario puede leer la recomendacion") {

                recomendacion2.puedeLeerLaRecomendacion(usuario3) shouldBe true
            }
            it("usuario no puede leer la recomendacion") {

                recomendacion1.puedeLeerLaRecomendacion(usuario2) shouldBe false
            }
        }
