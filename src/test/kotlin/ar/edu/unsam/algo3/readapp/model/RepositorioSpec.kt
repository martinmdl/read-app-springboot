...
class RepositorioSpec : DescribeSpec({
    ...
    val autorPipoConsagrado =
        Autor(null, "pipo", "Alegre", "yagoo", LocalDate.of(1969, 3, 27), Lenguaje.es_ES, 2)
    ...
    describe("Repositorio general.") {
        ...
        it("Se crea un libro") {
            ...
            repository.dataMap.keys.toList() shouldBe listOf(1)
        }
        ...
        it("Se busca un libro por id") {
            repository.create(libroDesafiante)
            repository.getById(1) shouldBe libroDesafiante
        }

        it("Se busca un libro por id que no existe") {
            val e = assertThrows<Businessexception> { repository.getById(6) }
            "No es necesario actualizar el id a 6" shouldBe e.message
        }
    }
    ...
    describe("Repositorio Libro") {
        ...
        val autorNoMatch =
            Autor(null, "Opip", "Ergela", "yagoo", LocalDate.of(1969, 3, 27), Lenguaje.es_ES, 2)
    ...
    describe("Repositorio Autor") {
        ...
        val autorMatchNombre =
            Autor(null, "frank", "fabra", "buro", LocalDate.of(1969, 3, 27), Lenguaje.es_ES, 0)
        val autorMatchApellido =
            Autor(null, "Opip", "robe", "burro", LocalDate.of(1969, 3, 27), Lenguaje.es_ES, 2)
        val autorMatchSeudonimo =
            Autor(null, "fran", "rober", "resid", LocalDate.of(1969, 3, 27), Lenguaje.es_ES, 2)
